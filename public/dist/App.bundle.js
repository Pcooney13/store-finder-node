    ...
    return new Promise(function () {
      function dispatchXhrRequest(resolve, reject) {
        ...
        if ('setRequestHeader' in request) {
          utils.forEach(requestHeaders, function () {
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 42.4;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -71.1;
...
Axios.prototype.request = function () {
  function request(config) {
    ...
    this.interceptors.request.forEach(function () {
      ...
      return unshiftRequestInterceptors;
    }());
    ...
    this.interceptors.response.forEach(function () {
      ...
      return pushResponseInterceptors;
    }());
...
InterceptorManager.prototype.forEach = function () {
  function forEach(fn) {
    utils.forEach(this.handlers, function () {
...
module.exports = function () {
  function dispatchRequest(config) {
    ...
    utils.forEach(['delete', 'get', 'head', 'post', 'put', 'patch', 'common'], function () {
    ...
    return adapter(config).then(function () {
...
module.exports = function () {
  function normalizeHeaderName(headers, normalizedName) {
    utils.forEach(headers, function () {
...
;(function (factory) {
    ...
    function factory(window) {
        ...
        var _addToSet = function () {
            function _addToSet(set, array) {
                var l = array.length;
                while (l--) {
        ...
        var _cloneObj = function () {
            function _cloneObj(object) {
                var newObject = {};
                var property;
         ...
         */
        var _createIterator = function () {
            function _createIterator(root) {
         ...
         */
        var _isClobbered = function () {
            function _isClobbered(elm) {
         ...
         */
        var _sanitizeElements = function () {
